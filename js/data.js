  ...
  technicalNote: {
    ...
    regulatoryBasis: {
      ...
      sourceRefs: [
        ...
        { label: "Oscar Efrem. \"Nota Técnica País 2024\": tablero de referencia sobre las ~22.693 tecnologías y medicamentos (CUPS/CUM) y sus frecuencias/costos que sustentan la UPC — fuente de terceros, no una publicación oficial de MinSalud, útil solo como referencia amplia: no especifica zona ni finalidad, según advirtió la propia autora de la metodología en el webinar citado abajo.", url: "https://oscarefrem.com/nota-tecnica-pais-2024/" },
        { label: "Jennifer Ortiz (Ministerio de Salud y Protección Social). Webinar \"Buenas prácticas para la elaboración de la nota técnica\" — transcripción propia del autor.", url: "https://www.youtube.com/watch?v=0wqgmnLIuUs" },
      ],
    },
    ...
    nextSteps: [
      { actor: "IPS y prestadores", action: "Conformar el equipo interdisciplinario mínimo que recomienda MinSalud para construir la nota técnica — epidemiología, economía/finanzas e ingeniería — y designar formalmente a quien firma el acuerdo como responsable de su seguimiento." },
    ...
    sources: "Basada en las sesiones 9, 11, 13, 14, 17, 20 y 22 del congreso; en las recomendaciones B y C de la revisión de gobernanza del autor (ver \"Análisis relacionado del autor\" en el Resumen); en la metodología oficial de la nota técnica (Decreto 780 de 2016 y su desarrollo de 2022 por MinSalud); en el webinar de buenas prácticas de Jennifer Ortiz (MinSalud); y en el tablero de referencia sobre la Nota Técnica País — las cuatro últimas citadas en \"0. Marco normativo\" y en el Panel de fuentes.",
    ...
    providerNoteTool: {
      ...
      branches: [
        ...
        },
        {
          ...
          items: ["Costos directos: personal asistencial, insumos, medicamentos — sin trasladar ineficiencias propias (p. ej., tiempo ocioso de personal) al valor pactado con la EPS", "Costos indirectos / overhead (recomendado no superar ~15% del valor asignado por servicio)", "Costos fijos vs. variables — elemento mínimo 4 de la norma (costos o valores acordados)", "Costo medio por afiliado, ponderado por zona si el prestador opera en más de un territorio (urbano/rural/disperso)", "Punto de equilibrio (break-even)"]
        },
        {
          id: 4, label: "Supuestos de utilización", sessions: [5, 22],
          items: ["Frecuencia de uso esperada por afiliado, ajustada al período de vigencia del acuerdo — elemento mínimo 3 de la norma (fórmula: frecuencia del período de referencia ÷ tiempo de ese período × tiempo de vigencia del acuerdo)", "Base epidemiológica o demanda proyectada, desagregada por finalidad y CIE-10, no solo por CUPS", "Las RIAS y guías de práctica clínica fijan una frecuencia mínima u obligatoria, no un techo — documente la desviación si la frecuencia real está por encima o por debajo", "Riesgo primario (incidencia/severidad) y riesgo técnico (utilización) — dos riesgos distintos que la norma exige diferenciar, y que dependen de qué se pactó, no solo de la modalidad de pago", "Estacionalidad o variabilidad esperada", "Fuente de los datos históricos (RIPS propios, histórico de facturación, o contraste con la Nota Técnica País)"]
        },
        {
          id: 5, label: "Modelo de pago propuesto", sessions: [22],
          items: ["Capitación / evento / paquete / PGP / resultado", "Justificación técnica de la modalidad", "Ajuste por inflación o IPC", "Periodicidad de revisión tarifaria"]
        },
        {
          id: 6, label: "Riesgo compartido y monitoreo", sessions: [22],
          items: ["Corredor de riesgo (risk corridor)", "Techo (stop-loss)", "Piso de garantía", "Responsabilidad por desviaciones — el riesgo técnico puede terminar en cabeza del pagador, no del prestador, cuando prescripción y dispensación se contratan por separado", "Periodicidad de monitoreo, siempre menor al horizonte del acuerdo (un acuerdo a 1 año no debería monitorearse solo una vez al año)"]
        },
        {
      ...
      template: {
        ...
        note: "Plantilla editable en Excel con 3 hojas enlazadas por botones de navegación: \"Guía\" (referencia normativa y de sesión del congreso de cada elemento), \"Ingreso de valores\" (los 8 elementos con un ejemplo prediligenciado en azul, listo para reemplazar) y \"Resumen\" (costo total, costo medio por afiliado, margen y punto de equilibrio, calculados automáticamente por fórmula a partir de lo que se diligencie). Las hojas están protegidas (sin contraseña): solo las celdas azules de ejemplo son editables, el resto queda bloqueado para no sobrescribir fórmulas o etiquetas por accidente. Los campos con riesgo de error de interpretación (tarifarios, frecuencias, riesgo primario/técnico, población) llevan una nota emergente con la fuente o la explicación al pasar el cursor, y los campos con opciones fijas (modalidad de pago, manual tarifario, periodicidad de monitoreo) usan listas desplegables en vez de texto libre. No existe un formato único de nota técnica exigido por ley — la norma exige el contenido, no una plantilla específica —, pero esta sí sigue los cuatro elementos mínimos, las fórmulas y las buenas prácticas del Decreto 780 de 2016 (MinSalud, 2022) y del webinar citado en \"0. Marco normativo\": no es un documento oficial, pero tampoco es una estructura inventada por esta síntesis."
      }
    },
  },
